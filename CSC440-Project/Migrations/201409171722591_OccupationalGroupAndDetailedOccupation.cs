namespace CSC440_Project.Migrations
{
    ...
    public partial class OccupationalGroupAndDetailedOccupation : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.DetailedOccupations", "OccupationalGroupId", "dbo.OccupationalGroups");
            DropIndex("dbo.DetailedOccupations", new[] { "OccupationalGroupId" });
            DropTable("dbo.OccupationalGroups");
            DropTable("dbo.DetailedOccupations");
        }
    }
}
